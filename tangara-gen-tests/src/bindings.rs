...
pub extern "C" fn tgLoad(ctx: &mut Context) {
	...
	let mut EnumStruct_type = MyPackage_package.add_type(186229043989425557);
	EnumStruct_type.set_dtor(EnumStruct_dtor);
	EnumStruct_type.add_method(837492378273562681, EnumStruct_Variant);
	let mut EnumMixed_type = MyPackage_package.add_type(5083507064775102309);
	...
	let mut EnumComplex_type = MyPackage_package.add_type(4724787910385973656);
